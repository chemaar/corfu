...
Finally, the frequency distribution of supplier and number of appearances is depicted on Figure~\ref{fig:results-graph-3} with the objective of presenting 
how the cloud of points (appearances) that initially were only one per supplier has 
...
\caption{Graphical view of supplier and number of appearances in the Australian rewarded contracts dataset.}
