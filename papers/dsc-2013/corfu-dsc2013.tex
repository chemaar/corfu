...
to design this task both a lemmatizer based on Wordnet and a grammar for corporate names has been designed, see Figure~\ref{figure:step-4}. 
Once words are tagged next step consists in filtering those non-relevant categories for corporate names keeping nouns and adjectives, as an example 
Figure~\ref{figure:step-5} shows how to walk and filter nodes in the parsed tree.
...
\end{lstlisting}
\caption{Filtering words by the category NP.}
\label{figure:step-5}
\end{center}
\end{figure}      
