...
% Following some background and basic definitions are presented: 
% \begin{itemize}
...
will be grouped by ``the most probably/used name'' according to threshold generated 
by the comparison function. This first version of CORFU has used the WRatio function to 
compare strings that is available in the Levenshtein Python utils package.
...
dataset as Table~\ref{config-corfu} shows.
