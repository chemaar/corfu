...
\author{Jose Mar\'{i}a \'{A}lvarez\inst{1} \and Michail Vafolopoulos\inst{2} \and Jos\'{e} Emilio Labra\inst{3}}
...
This work is part of the ``PublicSpending.net'' effort carried out in cooperation with Marios Meimaris (FIXME:affiliations), Giannis Xidias,
