...
\begin{document}
\title{Towards a stepwise method for unifying and reconciling corporate names in public contracts metadata. The CORFU technique.\thanks{\scriptsize This is the full version of the article including some source 
code listings, references and an appendix for a better understanding during the reviews. Nevertheless some of them will be omitted in a final version.} }
