...
\frame{
  \frametitle{Company, ORganization and Firm name Unifier-CORFU} 
}
...
\frame{
  ...
  \begin{alertblock}{Filter}
   \begin{description}
    ...
    \item [Process:] load set of stopwords (a minimal set of stopwords from the Python NLTK API has been used):
    \begin{itemize}
