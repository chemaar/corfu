...
\frame{
 ...
 \item Simiar initiatives: Openspending.net, LOD2 project e-Procurement, etc.
 \item \ldots
 \end{enumerate}
\end{block}
...
\frame{
  ...
  \begin{alertblock}{Clustering}
   \begin{description}
    \item [Input:] a set of strings derivated from the aforementioned tree.
...
\frame{
  ...
  \begin{enumerate}
   ...
   \item It must be technichally improved and extended to cover more datasets and to be ``smarter''.
  \end{enumerate}
